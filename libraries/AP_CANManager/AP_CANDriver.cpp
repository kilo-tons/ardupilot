...
const AP_Param::GroupInfo AP_CANManager::CANDriver_Params::var_info[] = {
    ...
    // @Values{Copter,Plane,Sub}: 0:Disabled,1:UAVCAN,2:KDECAN,3:ToshibaCAN,4:PiccoloCAN,5:CANTester,6:TattuCAN
    // @Values: 0:Disabled,1:UAVCAN,3:ToshibaCAN,4:PiccoloCAN,5:CANTester,6:EFI_NWPMU,7:USD1,8:TattuCAN
    // @User: Advanced
    // @RebootRequired: True
